...
This definition reflects positions that customarily require bar admission or are traditionally categorized within bar-passage-required employment.

The metric is calculated as:

Law Firms + Clerkships + Government + Public Interest
Total Graduates
Total Graduates
Law Firms + Clerkships + Government + Public Interest
	​
...
(251–500 + 501+) Law Firm Placements
Total Graduates
Total Graduates
(251–500 + 501+) Law Firm Placements
	​
...
“Federal Clerkships” refers exclusively to Article III and other federal judicial placements.
...
As a percentage of total graduates

As a percentage of total law firm placements

The second format reflects internal firm-size distribution and sums to 100%, facilitating structural comparison across institutions independent of overall placement volume.
...
Raw-data integrity — preserving official ABA counts without modification.

Denominator clarity — explicitly distinguishing between percentages of total graduates and percentages of subcategories.

Comparative neutrality — avoiding composite weighting schemes unless explicitly defined.
